...
class get_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "get_FM")
        ...
        self.channel_freq = channel_freq = 98400000
        ...
        self._channel_freq_range = Range(80000000, 108000000, 0.1, 98400000, 200)
...
def main(top_block_cls=get_FM, options=None):
